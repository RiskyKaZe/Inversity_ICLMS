...
def main():
    ...
    # Importing the CSV Database into Python as a Pandas Dataframe
    ...
    average_population_density_of_fish_weight = -0.5
    average_population_density_of_birds_weight = -1
    wind_consistency_weight = 3
    number_of_wildlife_migration_paths_weight = -2

    # Calculating the Score for Each Location in the Database such that Smaller Scores are Better Scores
    for index, row in dataframe.iterrows():
        ...
        dataframe.loc[index, "Score"] = score * (-1)
